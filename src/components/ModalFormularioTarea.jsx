...
const ModalFormularioTarea = () => {
    ...
    const {modalFormularioTareas, handleModalTarea, mostrarAlerta, alerta, submitTarea, tarea} = useRequerimientos();
    ...
    const handleSubmit = async e => {
        ...
        if([nombre, descripcion, fechaEntrega, prioridad].includes('')){
            mostrarAlerta({
                msg: 'todos los campos son oblgatorios',
                error: true
            })
            return;
        }

        await submitTarea({id, nombre, descripcion, fechaEntrega, prioridad, requerimiento: params.id});
                    ...
                    >
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    <Dialog.Title as="h3" className="uppercase text-lg leading-6 font-bold text-gray-900">
                                    ...
                                    <form className='my-10'
                                        ...
                                        <div className='mb-5'>
                                            ...
                                            <input 
                                                ...
                                                id='fechaEntrega'
                                                className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md'
                                                placeholder='Fecha de Entrega de la Tarea' 
                                                value={fechaEntrega}
